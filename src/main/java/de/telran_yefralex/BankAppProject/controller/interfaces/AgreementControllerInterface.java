...
public interface AgreementControllerInterface {
    ...
    ResponseEntity<List<AgreementDto>> getAll(Principal principal, HttpServletRequest request);
    ...
    ResponseEntity<List<AgreementDto>> getMyAgreements(Principal principal, HttpServletRequest request);
    @Operation(
            summary = "create a new agreement",
            description = "allows you to create a new agreement, requires the role of manager"
    )
    ResponseEntity<HttpStatus> createNewAgreement(@RequestBody AgreementDto agreementDto, Principal principal, HttpServletRequest request)
