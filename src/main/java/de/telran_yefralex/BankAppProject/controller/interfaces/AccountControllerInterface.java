...
public interface AccountControllerInterface {
    ...
    ResponseEntity<List<AccountDto>> getManagerAllAccount(Principal principal);
    ...
    ResponseEntity<List<AccountForClientDto>> getAllClientsAccount(Principal principal);
    ...
    ResponseEntity<AccountDto> getAccountByNumber(@PathVariable(name = "number") @Parameter(description = "enter account number") String accountNumber);

    @Operation(
            summary = "create a new account",
            description = "allows you to create a new account, requires the role of manager"
    )
    ResponseEntity<HttpStatus> createNewAccount(@RequestBody AccountDto accountDto, Principal principal)
